		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP Sales Application",
									"targetURL": "#comsatyasalesapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsatyasalesapp-display": {
								"semanticObject": "comsatyasalesapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.satya.salesapp",
									"url": sap.ui.require.toUrl("com/satya/salesapp")
								}
							}
						}
					}
